...
class CircusRostov(AsyncEventParser):
    def __init__(self, controller, name):
        ...
        self.url = 'https://www.circus-rostov.ru/'
        self.headers = {
    ...
    async def get_info_about_event(self, id):
        ...
        href = f'https://ticket-place.ru/widget/{id}/data|rostov'
    ...
    async def body(self):
        ...
        for event in a_events:
            self.register_event(event[0], event[1], date=event[2], venue='Ростовский цирк')